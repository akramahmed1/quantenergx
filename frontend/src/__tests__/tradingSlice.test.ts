...
describe('tradingSlice', () => {
  ...
  describe('position management', () => {
    ...
    test('should update existing position', () => {
      ...
      expect(state.positions[0].currentPrice).toBe(77.00);
    ...
    test('should calculate total portfolio value', () => {
      ...
      const expectedValue = (100 * 76.00) + (200 * 3.30);
  ...
  describe('market data management', () => {
    ...
    test('should update existing market data', () => {
      ...
      expect(state.marketData.CRUDE_OIL.price).toBe(76.50);
  ...
  describe('real-time updates integration', () => {
    test('should handle real-time price updates', () => {
      ...
      expect(state.marketData.CRUDE_OIL.price).toBe(76.00);
      ...
      expect(finalState.positions[0].currentPrice).toBe(76.00);
